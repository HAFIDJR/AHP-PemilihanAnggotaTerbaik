...
<head>
	...
	<title class="">Metode AHP (Analitycal Hierarchy Process) : Sistem Pendukung Keputusan</title>
...
<body style="background: #ffffff url(images/back1.jpg) left bottom fixed;">
	...
	<nav class="navbar navbar-inverse navbar-static-top">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" style="margin-top: 10px;" href="">AHP (Analitycal Hierarchy Processs)</a>
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav navbar-right">
					<li>
						<h4 class="navbar-brand"> Kelompok 5</h4>
					</li>
				</ul>
			</div><!-- /.navbar-collapse -->
		</div><!-- /.container-fluid -->
	...
	<div class="container">
		<div class="row d-flex ">
			<h6>Kelompok 7 </h6>
			<p>M Hafid Nur Firmansyah , Rizal </p>
		</div>
		<div class="row">
